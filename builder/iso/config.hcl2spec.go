...
type FlatConfig struct {
	...
	Tenant                    *string           `mapstructure:"tenant" required:"true" cty:"tenant" hcl:"tenant"`
	User                      *string           `mapstructure:"user" required:"true" cty:"user" hcl:"user"`
	...
	Specification             *string           `mapstructure:"specification" required:"true" cty:"specification" hcl:"specification"`
	InstanceName              *string           `mapstructure:"instance_name" required:"false" cty:"instance_name" hcl:"instance_name"`
	TargetTenant              *string           `mapstructure:"target_tenant" required:"true" cty:"target_tenant" hcl:"target_tenant"`
	RepositoryName            *string           `mapstructure:"repository_name" required:"true" cty:"repository_name" hcl:"repository_name"`
	ISOName                   *string           `mapstructure:"iso_name" required:"true" cty:"iso_name" hcl:"iso_name"`
	DiskSize                  *uint64           `mapstructure:"disk_size" required:"true" cty:"disk_size" hcl:"disk_size"`
	InstanceCIDR              *string           `mapstructure:"instance_cidr" required:"true" cty:"instance_cidr" hcl:"instance_cidr"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"tenant":                       &hcldec.AttrSpec{Name: "tenant", Type: cty.String, Required: false},
		...
		"specification":                &hcldec.AttrSpec{Name: "specification", Type: cty.String, Required: false},
		"instance_name":                &hcldec.AttrSpec{Name: "instance_name", Type: cty.String, Required: false},
		"target_tenant":                &hcldec.AttrSpec{Name: "target_tenant", Type: cty.String, Required: false},
		...
		"instance_cidr":                &hcldec.AttrSpec{Name: "instance_cidr", Type: cty.String, Required: false},
	}
	return s
}
